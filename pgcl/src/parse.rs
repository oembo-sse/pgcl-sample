...
pub fn parse_file(src: &str) -> Result<crate::ast::File, ParseError> {
    static PARSER: Lazy<crate::pgcl::FileParser> = Lazy::new(crate::pgcl::FileParser::new);

    PARSER.parse(src).map_err(|e| ParseError::new(src, e))
}

pub fn parse_expr(src: &str) -> Result<crate::ast::Expr, ParseError> {
    static PARSER: Lazy<crate::pgcl::ExprParser> = Lazy::new(crate::pgcl::ExprParser::new);
